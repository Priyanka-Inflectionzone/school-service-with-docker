...
import { register as registerSchoolRoutes } from "../api/school/school.routes";
import { register as registerRoleRoutes } from "../api/role/role.routes";
...
// import { register as registerEnrollmentScheduleRoutes
// } from "../api/enrollment/enrollment.schedule/enrollment.schedule.routes";
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                this._app.get('/api/v1/', (req, res) => {
                    res.send({
                        message : `School Management Service API [Version ${process.env.API_VERSION}]`,
                    });
                });

                registerSchoolRoutes(this._app);
